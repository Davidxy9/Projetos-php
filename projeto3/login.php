...
<font color="red"> 
<?php
	if(isset($_SESSION['emorreu']))
	{
		echo $_SESSION['emorreu'];
		unset($_SESSION['emorreu']);
	}
	elseif(isset($_SESSION['entrousemlogar']))
	{
		echo $_SESSION['entrousemlogar'];
...
Não tem conta?<a href="cadastro.php" > Registre-se</a><br>
<!--Esqueceu sua senha?<a href="redefinisenha.php" target="_blank"> Mudar a senha</a> -->

</font>		<!--
<form name="entrada" action="confirma.php" method="POST">
<br><br><br><br><br><b><center>Digite seu usuário:<input type='text' name='usuario'/><br></center><br>
<br><center>Digite sua senha:<input type='password' name='senha1'/><br></center><br>
<center><input type='submit' value='Entrar'><br><br></center>


</form>

<form name="entrada2" action="cadastro.php" method="POST">	
